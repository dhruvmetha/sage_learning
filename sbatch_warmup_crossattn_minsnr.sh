#!/bin/bash
#SBATCH --job-name=crossattn_warmup_crop64_minsnr
...
#SBATCH --output=/scratch/dm1487/slurm_logs/crossattn_warmup_minsnr_%j.out
#SBATCH --error=/scratch/dm1487/slurm_logs/crossattn_warmup_minsnr_%j.err
...
python src/train_generative.py \
    ...
    output_dir=/scratch/dm1487/runs/car_v1_aug9_depth1_p2_5_crop64_minsnr_500ep \
    name=warmup_car_v1_aug9_depth1_p2_5_crop64_minsnr_500ep \
    crop_size=64 \
    batch_size=64 \
    model.use_min_snr=true \
    max_epochs=500 \
