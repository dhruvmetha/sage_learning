#!/bin/bash
#SBATCH --job-name=vdiff_film_cg_dec2_2push_eval
#SBATCH --output=/common/users/tdn39/Robotics/Mujoco/sage_learning/job_scripts/slurm_logs/vdiff_film_cg_dec2_2push_eval_%j.out
#SBATCH --error=/common/users/tdn39/Robotics/Mujoco/sage_learning/job_scripts/slurm_logs/vdiff_film_cg_dec2_2push_eval_%j.err
...
# Train (Vector Diffusion FiLM + Coord Grid) on dec2 2-push -> Evaluate on 2-push filtered manifest.
# Usage: sbatch train_eval_vector_diffusion_film_coordgrid_dec2_2push.sh
# Resume: sbatch train_eval_vector_diffusion_film_coordgrid_dec2_2push.sh /path/to/checkpoint.ckpt
...
ARCH_NAME="vdiff_film_coordgrid"
